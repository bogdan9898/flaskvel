...
DefaultMessages = {
    ...
    'gte': {
        FieldTypes.NUMERIC: 'The {field_name} field must be greater than or equal {0}.',
        FieldTypes.FILE: 'The {field_name} field must be greater than or equal {0} kilobytes.',
        FieldTypes.STRING: 'The {field_name} field must be greater than or equal {0} characters.',
    ...
    'lt': {
        ...
        FieldTypes.STRING: 'The {field_name} field must be less than {0} characters.',
    ...
    'lte': {
        ...
        FieldTypes.STRING: 'The {field_name} field must be less than or equal {0} characters.',
        FieldTypes.ARRAY: 'The {field_name} field must not have more than {0} items.',
    },
    'max': {
        FieldTypes.NUMERIC: 'The {field_name} field may not be greater than {0}.',
        FieldTypes.FILE: 'The {field_name} field may not be greater than {0} kilobytes.',
    ...
    'min': {
        ...
        FieldTypes.STRING: 'The {field_name} field must be at least {0} characters.',
    ...
    'size': {
        ...
        FieldTypes.FILE: 'The {field_name} field must be {0} kilobytes.',
        FieldTypes.STRING: 'The {field_name} field must be {0} characters.',
        FieldTypes.ARRAY: 'The {field_name} field must contain {0} items.',
    },
