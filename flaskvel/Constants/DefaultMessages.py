...
DefaultMessages = {
    ...
    'between': {
        ...
        FieldTypes.STRING: 'The {field_name} field must be between {0} and {1} characters.',
    ...
    'dimensions': 'The {field_name} field has invalid image dimensions.',
    ...
    'gt': {
        ...
        FieldTypes.FILE: 'The {field_name} field must be greater than {0} kilobytes.',
        FieldTypes.STRING: 'The {field_name} field must be greater than {0} characters.',
    ...
    'gte': {
        FieldTypes.NUMERIC: 'The {field_name} field must be greater than or equal to {0}.',
        FieldTypes.FILE: 'The {field_name} field must be greater than or equal to {0} kilobytes.',
        FieldTypes.STRING: 'The {field_name} field must have {0} characters or more.',
        FieldTypes.ARRAY: 'The {field_name} field must have {0} items or more.',
        FieldTypes.JSON: 'The {field_name} field must have {0} keys or more.',
    },
    ...
    'json': 'The {field_name} field must be a valid JSON string.',
    'lt': {
        FieldTypes.NUMERIC: 'The {field_name} field must be less than {0}.',
        FieldTypes.FILE: 'The {field_name} field must be less than {0} kilobytes.',
    ...
    'lte': {
        FieldTypes.NUMERIC: 'The {field_name} field must be less than or equal {0}.',
        FieldTypes.FILE: 'The {field_name} field must be less than or equal {0} kilobytes.',
        FieldTypes.STRING: 'The {field_name} field must not have more than {0} characters.',
        FieldTypes.ARRAY: 'The {field_name} field must not have more than {0} items.',
        FieldTypes.JSON: 'The {field_name} field must not have more than {0} keys.',
    },
    'max': {
        FieldTypes.NUMERIC: 'The {field_name} field must not be greater than {0}.',
        FieldTypes.FILE: 'The {field_name} field must not be greater than {0} kilobytes.',
        FieldTypes.STRING: 'The {field_name} field must not have more than {0} characters.',
        FieldTypes.ARRAY: 'The {field_name} field must not have more than {0} items.',
        FieldTypes.JSON: 'The {field_name} field must not have more than {0} keys.',
    },
    ...
    'min': {
        ...
        FieldTypes.STRING: 'The {field_name} field must have at least {0} characters.',
        FieldTypes.ARRAY: 'The {field_name} field must have at least {0} items.',
        FieldTypes.JSON: 'The {field_name} field must have at least {0} keys.',
    },
    ...
    'size': {
        FieldTypes.NUMERIC: 'The {field_name} field must be equal to exactly {0}.',
        FieldTypes.FILE: 'The {field_name} field must be exactly {0} kilobytes.',
        FieldTypes.STRING: 'The {field_name} field must have exactly {0} characters.',
        FieldTypes.ARRAY: 'The {field_name} field must contain exactly {0} items.',
        FieldTypes.JSON: 'The {field_name} field must contain exactly {0} keys.',
    },
